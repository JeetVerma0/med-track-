...
// Absolute paths to the UI mockup images generated earlier
...
// ---------------------------------------------------
// Slide 1 – Title (gradient background, bold typography)
let s1 = pptx.addSlide();
s1.background = { fill: { color: "#F9FAFB" } };
...
// ---------------------------------------------------
// Slide 2 – The Problem (iconic bullet list)
...
s2.addText([
  ...
  x: 0.8, y: 1.5, w: 9, h: 3,
  fontSize: 18, color: "#334155", bullet: true, margin: 5
});
...
s3.addText([
  ...
  x: 0.8, y: 5.7, w: 9, h: 1.5,
  fontSize: 18, color: "#334155", bullet: true, margin: 5
});

// ---------------------------------------------------
// Slide 4 – Core Capabilities (text on left, episode detail on right)
...
s4.addText([
  ...
  x: 0.8, y: 1.5, w: 4.2, h: 2.5,
  fontSize: 18, color: "#334155", bullet: true, margin: 5
});
s4.addImage({ path: imgEpisode, x: 5.4, y: 1.3, w: 4.2, h: 3.5 });

// ---------------------------------------------------
// Slide 5 – Sharing & Accessibility (icons + bullets, subtle background)
...
s5.addText([
  ...
  x: 0.8, y: 1.5, w: 9, h: 2.5,
  fontSize: 18, color: "#334155", bullet: true, margin: 5
});
// faint background visual (dashboard)
s5.addImage({ path: imgDashboard, x: 0.5, y: 4.2, w: 9, h: 2.8, opacity: 0.15 });
...
// ---------------------------------------------------
// Slide 8 – Live Demo (two side‑by‑side screenshots)
